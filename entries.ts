export const entries: string[] = [
  ...
  'currently has 118 tabs open',
  'runs a humidifier and a dehumidifier at the same time',
  'always follows the instructions for Lego',
  'prefers tabs over spaces',
  'has specific mugs for tea, coffee, and hot chocolate',
  'uses jumper wires as hair ties',
  'wears pyjama bottoms in Zoom calls',
  'is neither a top nor a bottom',
  'always has a rubber duck in the bath',
  'peels bananas from the other end',
];
